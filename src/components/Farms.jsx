    ...
    <>
      <div
        ...
        style={ {backgroundImage: `url(${img}` }}
          >
          <span className="bg-black/60 text-white rounded-lg shadow-inner p-4">{children}</span>
    </div >
    </>
    ...
    {/* Main content area with backdrop styling */}
      ...
      <div className="m-8">
        <p className="text-lg md:text-xl lg:text-2xl text-center leading-relaxed">
          The Farms section presents a curated list of farms in a responsive grid layout,
          allowing users to easily browse through the available farms. Each farm is displayed
          with a simple, clean design that highlights its name, ensuring a clear and accessible presentation.
          The grid dynamically adjusts to different screen sizes, ensuring the layout remains balanced
          and visually appealing whether there are just a few farms or a larger selection.
          The responsive design ensures that the content is always displayed optimally, providing a seamless browsing experience.
        </p>
      </div>
      <div className="w-full h-full text-center font-bold">TODO Trying to display a popup on click<PopupFarm></PopupFarm></div> {/*TODO*/}
    </section>
  );
};
